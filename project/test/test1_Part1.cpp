...
int main(int argc, char const *argv[]) {
  if(argc == 2){
    ...
    cout << "Would you like to perform a symmetry of your image with regard to x-axis? ";
    cin >> answer;
    if (answer==affirmative ||  answer == affirmative2 || answer == affirmative3){
      img = BWImage(image);
      img.symmetry_X();
    ...
    cout << "Would you like to perform a symmetry of your image with regard to y-axis? ";
    cin >> answer;
    if (answer==affirmative ||  answer == affirmative2 || answer == affirmative3){
      img = BWImage(image);
      img.symmetry_Y();
    ...
    cout << "Would you like to perform a diagonal symmetry of your image? ";
    cin >> answer;
    if (answer==affirmative ||  answer == affirmative2 || answer == affirmative3){
        img = BWImage(image);
    ...
    cout << "This is the end of the demostration for the first part. Now, you can execute the next part or try some methods by yourself." << endl;
